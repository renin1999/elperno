          ...
          <form v-on:submit="guardarUser">
            <div class="mdl-grid">
              ...
              <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
                ...
                <h5 class="text-condensedLight">Dueño de la nueva cuenta</h5>
                ...
                <p class="text-center">
                  <button
                    ...
                    <div class="mdl-tooltip" for="btn-addCategory" v-on:click="guardarUser()">
                      Añadir cuenta de ingreso de nuevo gerente
                    </div>
                  </button>
                </p>
              </div>
...
export default {
  ...
  methods: {
    ...
    async guardarUser() {
      ...
      const anotherResponse = await fetch('http://127.0.0.1:8000/api/v1/user/', {
        method: "POST",
      ...
      var anotherdata = anotherResponse.json();
      //use the anotherdata...
