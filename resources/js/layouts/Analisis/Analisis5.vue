<template>
    <div id="principal"><canvas id="myChart5"></canvas></div>
</template>
...
var datos = []
var respuesta = []
const top5marcasventa = fetch('http://127.0.0.1:8000/api/v1/top5productosvendidos/')
...
onMounted(() => {
  const canvasTag = <ChartItem>document.getElementById('myChart5');
