...
<head>
    ...
    'resources/js/js_views/ploty-latest.min.js'
	])
</head>
<body>
	<!-- Notifications area -->
                ...
                <ul class="list-unstyle">
                    ...
                    Bienvenido {{ Auth::user()->username }}
                        <button type="button" data-bs-toggle="dropdown"
                            style="background-color:transparent; border:none;  width: 50px;" href="#"
                            class="btn btn-default btn-lg dropdown-toggle" data-toggle="dropdown">  </button>
	...
	<!-- pageContent -->
	<section class="full-width pageContent" id="AnalisisPageContent" >
	</section>	
	@endif
