...
<body>
                ...
                <ul class="list-unstyle">
                    ...
                    <div class="dropdown">
                        <button type="button" data-bs-toggle="dropdown"
                            ...
                            class="btn btn-default btn-lg dropdown-toggle" data-toggle="dropdown"> Bienvenido
                        ...
                        <div class="dropdown-content">
                            ...
                            <form action="/logout" method="POST">
                                @csrf
                                <a href="{{ route('login') }}"><button type="button" data-bs-toggle="dropdown"
                                        style="background-color:transparent; border:none;">Cerrar Sesión</button></a>
                            </form>
                        </div>
                    </div>
    ...
    <section class="full-width navLateral" id="Home" usern="remi">
        <script>
        window.auth_user = {
            !!json_encode([
                'id' => auth() - > user() - > id,
    ...
    <!-- pageContent -->
    <section class="full-width pageContent" id="HomeContent">
    </section>
    @endif
